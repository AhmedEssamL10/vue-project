                        ...
                        <form class="form-step">
                          ...
                          <div class="flex flex-col gap-4">
                            <div class="form_control_wrapper">
                              ...
                              <span v-if="companyChooseError" class="error-msg">رجاءا قم بإختيار ماذا تريد</span>
                            </div>
                          </div>
                        </form>
                      </div>
                          ...
                          <div class="flex flex-col gap-4 mb-4">
                            ...
                            <div class="form_control_wrapper">
                              <div>
                                ...
                                <input id="location" v-model="v$.formData.pickupLocation.$model" placeholder="المدينة"
                                  class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                            ...
                            <div class="form_control_wrapper">
                              <div class="grid grid-cols-[auto_100px] gap-2">
                                <div>
                                  ...
                                  <input id="address" v-model="v$.formData.pickupAddress.$model" placeholder="الشارع"
                                    class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                                ...
                                <div>
                                  ...
                                  <input id="number" v-model="v$.formData.pickupNo.$model" placeholder="الرقم"
                                    class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                              ...
                              <div class="flex flex-col gap-3">
                                ...
                                <label class="label cursor-pointer">
                                  <input :readonly="true" :checked="isKitchenDismantingChecked"
                                    @click="handleCheckToggle($event, 'kitchenLong', 'kitchenDismanting')"
                                    type="checkbox"
                                    class="checkbox border !bg-transparent checked:border-client-dark border-client-dark checked:before:bg-client" />
                                  <span @click.prevent="showModal('kitchenDismanting', 'kitchenLong')"
                                    class="label-text text-[#1b1718]">تفكيك المطبخ</span>
                                </label>
                                ...
                                <label class="label cursor-pointer">
                                  ...
                                  <span @click.prevent="showModal('movingBoxes', 'movingBoxes')"
                                    class="label-text text-[#1b1718]">توفير صناديق النقل</span>
                                </label>
                                ...
                                <label class="label cursor-pointer">
                                  ...
                                  <span @click.prevent="showModal('furnitureStore', 'furnitureStoreDays')"
                                    class="label-text text-[#1b1718]">تخزين الأثاث</span>
                                </label>
                                ...
                                <label class="label cursor-pointer">
                                  ...
                                  <span @click.prevent="showModal('furnitureQuantity', 'furnitureQuantity')"
                                    class="label-text text-[#1b1718]">التخلص من الأثاث</span>
                                </label>
                          ...
                          <div class="flex flex-col gap-4 mb-4">
                            ...
                            <div class="form_control_wrapper">
                              <div>
                                <label for="location"
                                  class="block text-sm font-medium text-gray-700 mb-1">المدينة</label>
                                <input id="location" v-model="v$.formData.dropOffLocation.$model" placeholder="المدينة"
                                  class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                            ...
                            <div class="form_control_wrapper">
                              <div class="grid grid-cols-[auto_100px] gap-2">
                                <div>
                                  <label for="address"
                                    class="block text-sm font-medium text-gray-700 mb-1">الشارع</label>
                                  <input id="address" v-model="v$.formData.dropOffAddress.$model" placeholder="الشارع"
                                    class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                                    :class="{ 'input-error': v$.formData.dropOffAddress.$error }" />
                                </div>
                                <div>
                                  <label for="number" class="block text-sm font-medium text-gray-700 mb-1">الرقم</label>
                                  <input id="number" v-model="v$.formData.dropOffNo.$model" placeholder="الرقم"
                                    class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                              ...
                              <div class="flex flex-col gap-3">
                                ...
                                <label class="label cursor-pointer">
                                  ...
                                  <span @click.prevent="showModal('kitchenConstruction', 'kitchenLongMoveOut')"
                                    class="label-text text-[#1b1718]">تركيب المطبخ</span>
                                </label>
                        ...
                        <form class="form-step">
                          <div class="mb-4">
                            ...
                            <div class="flex flex-col gap-4 mb-4">
                              ...
                              <div id="dateRangeWrapper" v-if="v$.formData.timeType.$model === 'range'"
                                class="dateRange">
                          ...
                          <div class="mb-4">
                            ...
                            <div class="flex flex-col gap-4 mb-4">
                              <div class="form_control_wrapper">
                                <div>
                                  <label for="name" class="block text-sm font-medium text-gray-700 mb-1">*الإسم</label>
                                  <input id="name" v-model="v$.formData.clientName.$model" placeholder="الإسم"
                                    class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                              ...
                              <div class="form_control_wrapper">
                                <div>
                                  <label for="phone" class="block text-sm font-medium text-gray-700 mb-1">رقم
                                    الهاتف*</label>
                                  <input id="phone" v-model="v$.formData.clientPhone.$model" placeholder="رقم الهاتف"
                                    class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]"
                      ...
                      <template v-else>
                        <template v-if="currentPopupType === 'kitchenDismanting'">
                          <div class="flex justify-between items-center mb-6">
                            ...
                            <button
                              @click="closeModal({ modelValue: 'kitchenLong', checkboxValue: 'kitchenDismanting' })"
                        ...
                        <template v-if="currentPopupType === 'kitchenConstruction'">
                          <div class="flex justify-between items-center mb-6">
                            ...
                            <button
                              @click="closeModal({ modelValue: 'kitchenLongMoveOut', checkboxValue: 'kitchenConstruction' })"
                              type="button" class="btn btn-sm btn-circle btn-ghost text-xl">✕</button>
                          </div>
                          <h3 class="text-lg font-semibold mb-2">كم طول المطبخ بالمتر الذى تريد تركيبة ؟</h3>
                          <div class="grid grid-cols-[auto_20px] gap-2 items-center">
                            <input v-model="tempFormData.kitchenLongMoveOut" placeholder="كم طول المطبخ بالمتر ؟"
                              class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]" />
                            <span>m</span>
                          </div>
                          <div class="modal-action">
                        ...
                        <template v-if="currentPopupType === 'furnitureQuantity'">
                          ...
                          <h3 class="text-lg font-semibold mb-2">ما الذى تريد التخلص منه ؟</h3>
                          <input v-model="tempFormData.furnitureQuantity" placeholder="أريكة, 2 كرسى"
                            class="w-full px-4 py-3 rounded-lg bg-white transition duration-200 outline-none border border-[#1b1718] text-[#1b1718]" />
                          <div class="modal-action">
  ...
  setup() {
    ...
    const rules = {
      formData: {
        ...
        pickupLifterExistance: { required: helpers.withMessage('وجود الأسانسير مطلوب.', required) },
        pickupDistanceToCar: { required: helpers.withMessage('المسافة إلى السيارة مطلوبة.', required) },
        ...
        dropOffDistanceToCar: { required: helpers.withMessage('المسافة إلى السيارة عند التسليم مطلوبة.', required) },
        dropOffFloorNumber: { required: helpers.withMessage('رقم الطابق عند التسليم مطلوب.', required) },
        dropOfflifterExistance: { required: helpers.withMessage('وجود المرفعة عند التسليم مطلوبة.', required) },
