    ...
    <section class="py-12 bg-[#f1f1f1]">
        <div class="container relative z-10">
            <div class="max-w-3xl mx-auto">
                <div class="mt-8">
                    <dialog
                        v-if="creditionals_modal_shown"
                        ref="creditionals_modal"
                        id="creditionals_modal"
                        class="modal"
                    >
                                    ...
                                    <div class="flex flex-col">
                                        <div
                                            v-if="
                                                ...
                                                servicesCosts.boxPrice != '0'
                                            "
                                            class="flex justify-between items-center gap-4 border-b borde-black pb-4 mb-4"
                                        >
                                            <span>{{ $t("boxesCost") }}</span>
                                            <span class="font-bold"
                                                >{{ servicesCosts.boxPrice }}
                                                {{ $t("euro") }}</span
                                            >
                                        ...
                                        >
                                            ...
                                            <span class="font-bold text-sm">
                                                {{
                                                    $t(
                                                        "costWillBeCalculatedNSendInOfferMail"
                                                    )
                                                }}</span
                                            >
                                        </div>
                    ...
                    <template v-else>
                        <!-- Client Type -->
                        <template
                            v-if="stepNumber === 0 && companyStepNumber === 0"
                        >
                        ...
                        <template v-if="clientType === 'company'">
                            <template v-if="companyStepNumber === 1">
                                ...
                                <div class="max-w-xl mx-auto">
                                    <div
                                        class="btn_wrapper flex items-center gap-2"
                                    >
                                        <button
                                            @click="companyStepNumber = 0"
                                            type="button"
                                            class="bg-transparent border border-client hover:bg-client-dark transition hover:text-white text-client px-6 py-2 rounded mr-2"
                                        >
                                            {{ $t("back") }}
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            class="text-info font-bold text-xs"
                                                        >
                                                            {{
                                                                $t(
                            ...
                            <dialog
                                ref="companySaveDataModal"
                                id="companySaveDataModal"
                                class="modal text-black"
                            >
                                <form
                                    @submit.prevent
                                    class="modal-box bg-white saveDataForm"
                                >
                                    <h3 class="text-lg font-bold">
                                        {{ $t("save_data") }}
                                    </h3>
                                    ...
                                    <div class="modal-action">
                                        <button
                                            @click="submitCompanyRequestData"
                                            :class="
                                                isLoading
                        ...
                        >
                                    ...
                                    <div class="form_step_parent">
                                        <form class="form-step" id="movingFrom">
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="grid grid-cols-[auto_100px] gap-2"
                                                    >
                                                        <div>
                                                            <label
                                                                for="address"
                                            ...
                                            >
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        >
                                                        <div
                                                            class="grid grid-cols-[auto_20px] gap-2 items-center"
                                                        >
                                                            <input
                                                                type="number"
                                                                id="pickUpDistanceToCar"
                                                                v-model="
                                                                    v$.formData
                                                                        .pickupDistanceToCar
                                                                        .$model
                                            ...
                                            <div class="mb-4">
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        >
                                                            <div
                                                                class="flex flex-col items-start gap-3 mb-3"
                                                            >
                                                                <label
                                                                    class="custom-option p-3 grid grid-cols-[35px_auto] gap-2"
                                                                >
                                                                    <input
                                                                        v-model="
                                                                            v$
                                                                    ...
                                                                    <span
                                                                        class="label-text w-full text-start"
                                                                    >
                                                                        <span
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <path
                                                                            opacity="0.75"
                                                                            d="M14.5 30.9531V0.953125H29.5V30.9531H14.5Z"
                                                                            fill="white"
                                                                            stroke="white"
                                                                            stroke-width="0.5"
                                                                        />
                                                                        <path
                                                                            d="M15.5 1.95312C15.5 12.4917 15.5 20.4146 15.5 30.9531"
                                                                            stroke="#2B65D9"
                                                                            stroke-width="1.5"
                                                        ...
                                                        >
                                                            <div
                                                                class="grid grid-cols-[50%_40%] gap-4"
                                                            >
                                                                <div
                                                                    class="form_control_wrapper"
                                                                >
                                                                ...
                                                                <div
                                                                    class="form_control_wrapper col-span-full"
                                                                    v-if="
                                                                        v$
                                                                            .formData
                                                                            .selectedPickUpType
                            ...
                            <template v-if="stepNumber === 4">
                                <div
                                    v-if="user && prefilledDataAlertShown"
                                    class="alert alert-info mb-4 flex flex-col items-start gap-2"
                                >
                                    <p>
                                    ...
                                    <button
                                        @click="prefilledDataAlertShown = false"
                                        type="button"
                                        class="btn btn-outline"
                                    >
                                        {{ $t("close") }}
                            ...
                            <dialog id="saveDataModal" class="modal text-black">
                                ...
                                >
                                    <template
                                        v-if="currentPopupType === 'saveData'"
                                    >
                                        <h3 class="text-lg font-bold">
                                            {{ $t("saveData.title") }}
                                        </h3>
                                    ...
                                    <template v-else>
                                        ...
                                        >
                                            ...
                                            >
                                                <input
                                                    v-model="
                                                        tempFormData.kitchenLongMoveOut
                                                    "
                                                    :placeholder="
                                                        $t(
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <input
                                                                type="radio"
                                                                name="movingBoxesType"
                                                                v-model="
                                                                    tempFormData.movingBoxes
                                                                "
                                                                value="rent"
                                                                class="radio border !bg-transparent checked:border-client-dark border-client-dark checked:before:bg-client"
                                                            />
                                        ...
                                        >
                                            ...
                                            >
                                                <input
                                                    type="number"
                                                    v-model="
                                                        tempFormData.furnitureStoreDays
                                                    "
                                                    :placeholder="
                                                        $t(
                                        ...
                                        >
                                            ...
                                            <input
                                                v-model="
                                                    tempFormData.furnitureQuantity
                                                "
                                                :placeholder="
                                                    $t(
...
export default {
    ...
    watch: {
        ...
        "v$.formData.selectedPickUpType.$model": function (newVal) {
            if(newVal == 'boxes'){
              if(this.v$.formData.roomsNumber.$model){
                this.v$.formData.roomsNumber.$model = '';
              }

              if(this.v$.formData.spaceArea.$model){
                this.v$.formData.spaceArea.$model = '';
              }

              if(this.v$.formData.whatParts.$model){
                this.v$.formData.whatParts.$model = '';
              }
            }else{
              
              if(this.v$.formData.boxesNumber.$model){
                this.v$.formData.boxesNumber.$model = '';
              }
            }
        },
