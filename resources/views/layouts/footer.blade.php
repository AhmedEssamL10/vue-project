    ...
    <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-2">
                    <li>
                        <a class="flex items-start group" href="tel:+4915560233302">
                            ...
                            <span class="text-gray-400 transition group-hover:text-white">+4915560233302</span>
                        </a>
                    </li>
                    <li>
                        <a class="flex items-start group" href="tel:+4920334975316">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 text-gray-400 transition group-hover:text-white me-2 mt-1" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="text-gray-400 transition group-hover:text-white">+4920334975316</span>
                        </a>
                    </li>
                    <li>
